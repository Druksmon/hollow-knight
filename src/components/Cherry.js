        ...
        <div id='team-cherry' className="cherry_container">
            <div className="cherry_selector">
                ...
                <motion.p  initial={{opacity: 0, y: 50}}
                           whileInView={{opacity: 1, y: 0}}
                           viewport={{once: true}}
                           transition={{duration: 1.2}}>Hollow Knight is being developed by Team Cherry in Adelaide, South Australia. We're a team of 3
                ...
                <motion.button  initial={{opacity: 0, y: 50}}
                                whileInView={{opacity: 1, y: 0}}
                                viewport={{once: true}}
                                transition={{duration: 1.2,delay :0.3}}>Visit the Team Cherry Site</motion.button>
            ...
            <div className="cherry_logos">
                <motion.div initial={{opacity: 0, y: 50}}
                            whileInView={{opacity: 1, y: 0}}
                            viewport={{once: true}}
                            transition={{duration: 0.5,delay :0.2}} className="cherry_logo">
                ...
                <motion.div initial={{opacity: 0, y: 50}}
                            whileInView={{opacity: 1, y: 0}}
                            viewport={{once: true}}
                            transition={{duration: 0.5,delay :0.4}} className="cherry_logo">
                    <svg xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 576 512">
                        <path
                ...
                <motion.div initial={{opacity: 0, y: 50}}
                            whileInView={{opacity: 1, y: 0}}
                            viewport={{once: true}}
                            transition={{duration: 0.5,delay:0.6}} className="cherry_logo">
                    <svg xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 320 512">
                        <path
