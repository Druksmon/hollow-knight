            ...
            <div className="unity_container">
                <div className="unity_logo">
                    <motion.h3  initial={{opacity: 0, y: -50}}
                                ...
                                viewport={{once: true}}
                                transition={{duration: 0.5}} >Made with</motion.h3>
                ...
                <motion.p initial={{opacity: 0, y: 50}}
                          whileInView={{opacity: 1, y: 0}}
                          viewport={{once: true}}
                          transition={{duration: 0.5}} >Learn about the methods we used to make Hollow Knight, and about the engine under-pinning the whole
                    game.
                </motion.p>
                <motion.button initial={{opacity: 0, y: 50}}
                               whileInView={{opacity: 1, y: 0}}
                               viewport={{once: true}}
                               transition={{duration: 0.5}}>DETAILS</motion.button>
            </div>
        </>
    )
}
